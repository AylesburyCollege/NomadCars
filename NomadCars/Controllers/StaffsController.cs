...
namespace NomadCars.Controllers
{
    ...
    public class StaffsController : Controller
    {
        ...
        {
            var staff = db.Staff.Include(s => s.Person);
        ...
        public ActionResult Create([Bind(Include = "StaffID,Department,JobPosition,Salary,StartDate,ImageURL,Description")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffID,Department,JobPosition,Salary,StartDate,ImageURL,Description")] Staff staff)
        {
            if (ModelState.IsValid)
            {
